...
const ManageRaffles = ({
  ...
  useLayoutEffect(() => {
    ...
    const hasRaf = isBrowser && typeof window.requestAnimationFrame === "function";
    const cancelRaf =
      isBrowser && typeof window.cancelAnimationFrame === "function"
        ? window.cancelAnimationFrame
        : null;
    const rafId = hasRaf ? window.requestAnimationFrame(applyMetrics) : null;
    let cleanup = () => {};
